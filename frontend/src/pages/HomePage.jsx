        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          ...
          >
            <div className="flex flex-col items-center">
              ...
              <p className="text-gray-600 text-center">
                Efficiently manage student records, track performance metrics, and generate comprehensive reports
              </p>
              <span className="mt-4 text-indigo-600 font-medium group-hover:underline">Sign in as admin →</span>
            </div>
          </Link>
        </div>

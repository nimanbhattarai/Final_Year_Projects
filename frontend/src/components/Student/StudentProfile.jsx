...
import { User, Book, Award, MessageSquare, GraduationCap, Facebook, Instagram, Linkedin, Github, ExternalLink, MapPin, Hash, Mail, Calendar } from "lucide-react";
...
const StudentProfile = () => {
  ...
  return (
    <div className="max-w-5xl mx-auto p-6">
      ...
      {/* Student Information Section - Similar to Admin Panel */}
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden mb-6">
